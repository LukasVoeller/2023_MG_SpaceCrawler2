...
@onready var progressbar = $PopupFront/VBoxContainer/TextureProgressBar
...
func _on_FrameDelay_value_changed(value):
	...
	set_giftime.disconnect("value_changed",Callable(self,"_on_GifTime_value_changed"))
...
func _on_GifTime_value_changed(value):
	...
	set_delay.disconnect("value_changed",Callable(self,"_on_FrameDelay_value_changed"))
